...
def postgres_healthcheck():
    ...
    **Required Environment Variables:**
    ...
    :raises psycopg2.Error: When database connection fails
...
def mssql_healthcheck():
   ...
   and execute a version query. Note: Currently uses psycopg2 which
   ...
   **Required Environment Variables:**
   ...
   .. warning::
      This function incorrectly uses psycopg2 for MSSQL connections.
